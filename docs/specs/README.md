...
| Round D — publishing and graphics | [`ROUND_D_PUBLISHING_GRAPHICS_v4.md`](../../../uDosConnect/uDosDev/docs/specs/v4/ROUND_D_PUBLISHING_GRAPHICS_v4.md) | **Locked** — uDosPublish, UVIL, Classic Modern; pairs with [`UNIVERSAL_VECTOR_IL_UVIL_v1.md`](../../../uDosConnect/uDosDev/docs/specs/v4/UNIVERSAL_VECTOR_IL_UVIL_v1.md) |
| Classic Modern — inspiration kit | [`CLASSIC_MODERN_INSPIRATION_KIT_v1.md`](../../../uDosConnect/uDosDev/docs/specs/v4/CLASSIC_MODERN_INSPIRATION_KIT_v1.md) | **Locked** — fonts, gradients, patterns, icons; extends Round D foundation tokens; **Part 9** → USXD wireframe/YAML/tokens in **UniversalSurfaceXD** ([`surface-classic-modern-desktop.json`](https://github.com/fredporter/UniversalSurfaceXD/blob/main/interchange/examples/surface-classic-modern-desktop.json), composer `?sample=classicModern`) |
| Round F — roadmap | [`ROUND_F_ROADMAP_v4.md`](../../../uDosConnect/uDosDev/docs/specs/v4/ROUND_F_ROADMAP_v4.md) | **Locked** — parallel tracks, alpha fresh start, deferred v5+ |
