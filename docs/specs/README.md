...
| Classic Modern — inspiration kit | [`CLASSIC_MODERN_INSPIRATION_KIT_v1.md`](../../../uDosConnect/uDosDev/docs/specs/v4/CLASSIC_MODERN_INSPIRATION_KIT_v1.md) | **Locked** — fonts, gradients, patterns, icons; extends Round D foundation tokens |
