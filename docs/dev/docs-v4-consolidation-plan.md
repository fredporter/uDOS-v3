...
- **Round C — physical layer (locked):** [`ROUND_C_PHYSICAL_LAYER_v4.md`](../../uDosConnect/uDosDev/docs/specs/v4/ROUND_C_PHYSICAL_LAYER_v4.md) — uRing, DIY NFC, LEGO uNode stub.
- **Round D — publishing and graphics (locked):** [`ROUND_D_PUBLISHING_GRAPHICS_v4.md`](../../uDosConnect/uDosDev/docs/specs/v4/ROUND_D_PUBLISHING_GRAPHICS_v4.md) — uDosPublish, UniversalVectorIL, Classic Modern.
- **Round F — roadmap (locked):** [`ROUND_F_ROADMAP_v4.md`](../../uDosConnect/uDosDev/docs/specs/v4/ROUND_F_ROADMAP_v4.md) — parallel tracks, alpha fresh start, deferred v5+.
