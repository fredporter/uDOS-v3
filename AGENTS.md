...
- **Design / surfaces:** [UniversalSurfaceXD](https://github.com/fredporter/UniversalSurfaceXD) (v4 lab) — grid/interchange alignment; **canon** text in [docs/GRID-GRAPHICS-CANON.md](docs/GRID-GRAPHICS-CANON.md). **Vector / UVIL:** sibling **[UniversalVectorIL](../UniversalVectorIL)** — assets per **Round D** [`ROUND_D_PUBLISHING_GRAPHICS_v4.md`](../uDosConnect/uDosDev/docs/specs/v4/ROUND_D_PUBLISHING_GRAPHICS_v4.md). **Sonic / Ventoy / USXD:** family **[`SONIC_SCREWDRIVER_v4_COMPLETE_BRIEF.md`](../uDosConnect/uDosDev/docs/specs/v4/SONIC_SCREWDRIVER_v4_COMPLETE_BRIEF.md)**; **flashable OS (Ubuntu, Xubuntu, Classic Modern Mint):** **[`SONIC_v4_FLASHABLE_OS_IMAGES.md`](../uDosConnect/uDosDev/docs/specs/v4/SONIC_v4_FLASHABLE_OS_IMAGES.md)**; colours **[`COLOUR_SPEC_v4_ADDENDUM_SONIC_USXD.md`](../uDosConnect/uDosDev/docs/specs/v4/COLOUR_SPEC_v4_ADDENDUM_SONIC_USXD.md)**; **`npm run blocktext`** in this repo. **uCode runtime (Go):** **[`UCODE_v4_IMPLEMENTATION_LOCK.md`](../uDosConnect/uDosDev/docs/specs/v4/UCODE_v4_IMPLEMENTATION_LOCK.md)** (package tree + CLI).
